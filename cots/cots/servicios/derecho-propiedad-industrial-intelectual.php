...
<section class="page-header">
	<div class="container text-right">
		...
		<h1>Derecho de propiedad industrial e intelectual</h1>
		<span class="font-lato size-18 weight-300">We believe in Simple & Creative</span>

		<!-- breadcrumbs -->
		<ol class="breadcrumb breadcrumb-inverse">
			<li><a href="../">Inicio</a></li>
			<li class="active">Derecho de propiedad industrial e intelectual</li>
		</ol><!-- /breadcrumbs -->
	...
	<div class="container">
		...
		<div class="margin-top-60">
			<ul class="nav nav-tabs nav-clean">
				<li class="active"><a href="#tab1" data-toggle="tab">Architecture</a></li>
				<li><a href="#tab2" data-toggle="tab">Web Design</a></li>
				<li><a href="#tab3" data-toggle="tab">Video Editing</a></li>
			</ul>

			<div class="tab-content">
				<div id="tab1" class="tab-pane fade in active">
					<img class="pull-left" src="../assets/images/demo/mockups/600x399/11-min.jpg" width="200" alt="" />
					<p>Praesent est laborum dolo rumes fugats untras. Etha rums ser quidem rerum facilis dolores nemis onis fugats vitaes nemo minima rerums unsers sadips amets. Ut enim ad minim veniam, quis nostrud Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci amets uns. Etharums ser quidem rerum. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Asunt in anim uis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla dolores ipsums fugiats. Etha rums ser quidem rerum facilis dolores nemis onis fugats vitaes nemo minima rerums unsers sadips amets.<p>
				</div>
...
<div class="callout alert alert-transparent noborder noradius nomargin">
	...
	<div class="text-center">
		...
		<h3>Contacta con nosotros y tendras la primera consulta <span><strong>¡gratuita!</strong></span></h3>
		<!--<p class="font-lato size-20">
			We truly care about our users and our product.
		</p>-->
		
		<a href="../contacto.php" class="btn btn-primary btn-lg margin-top-30">CONTACTA</a>
